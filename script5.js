...
var ball = new THREE.Mesh(new THREE.SphereBufferGeometry(1, 32, 32), new THREE.MeshStandardMaterial({envMap: cubemap, roughness: 0.75, metalness: 1.0, envMapIntensity: 2}));
